...
**278 of 375 implemented.**

| | |
|---|---|
| ✅ | implemented |
| ⊘ | answered deliberately, and the answer is `ENOSYS` (18 calls) — most are ones Linux does not implement either; `rseq` is the one that could have been and is not, for the reason in `src/proc/rseq.c` |
