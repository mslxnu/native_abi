...
reports 172 syscalls translated against NABI's 316, and states that it lacks
...
fanotify. It has `clone3` and the robust futex list as well, which it did not when
this comparison was first written.
...
<details>
<summary>The full table (375 calls)</summary>
