...
reports 172 syscalls translated against NABI's 204, and states that it lacks
...
<details>
<summary>The full table (398 calls)</summary>
...
```
util/gen_syscall_doc.py /usr/include/asm-generic/unistd.h \
