...
DEFINE_NOT_IMPLEMENTED_SYSCALL(restart_syscall)
DEFINE_NOT_IMPLEMENTED_SYSCALL(_sysctl)
DEFINE_NOT_IMPLEMENTED_SYSCALL(swapoff)
DEFINE_NOT_IMPLEMENTED_SYSCALL(swapon)
DEFINE_NOT_IMPLEMENTED_SYSCALL(settimeofday)
